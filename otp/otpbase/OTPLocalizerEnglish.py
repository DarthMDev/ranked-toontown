...
CRSpecifyServerSelection = 'Would you like to connect to the public server or another server?'
CRSingleplayer = 'Singleplayer'  # Deprecated - kept for compatibility
CRLocalMultiplayer = 'Other Server'
...
CREnterGameserver = 'Please type in the IP/Server Address of the server you would like to connect to. (Port default is 7198. Leave blank for localhost.)'
