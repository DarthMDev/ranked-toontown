...
CRSpecifyServerSelection = 'Would you like to play Singleplayer? Connect to the public server? Or connect to a Local Multiplayer server?'
CRSingleplayer = 'Singleplayer'
CRLocalMultiplayer = 'Local Multiplayer'
CRPublicServer = 'Public Server'
CRSelectDatabaseBackend = 'Select Database Backend:\n\nFilesystem: Fast startup, data resets when you close the game.\n\nMongoDB: Persistent data, requires MongoDB to be running.'
CRFilesystem = 'Filesystem'
CRMongoDB = 'MongoDB'
CREnterUsername = 'Please type in a username to continue. Press enter when done.'
CREmptyUsername = 'Please reenter your username. It cannot be empty.'
CRInvalidUsername = 'Please enter a valid username.'
CREnterGameserver = 'Please type in the IP/Server Address of the Local Multiplayer server you would like to connect to. (Port default is 7198. Gameserver default is your local IP.)'
CREmptyGameserver = 'Please reenter the gameserver. It cannot be empty.'
