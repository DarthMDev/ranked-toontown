...
TugOfWarPowerMeterLabel = 'Power Meter'
TugOfWarPowerMeterTooSlow = 'Too\nslow'
TugOfWarPowerMeterTooFast = 'Too\nfast'
...
EscapeTitle = 'Toon Escape'
EscapeInstructions = 'Escape from the ' + Cog + ' den as soon as you can. Use arrow keys to run/jump and Ctrl to squirt a ' + Cog + '. Collect ' + Cog + ' treasures to gain even more points.'
EscapeElevatorExit = 'EXIT'
...
KartOutOfBusiness = 'The kart seems to be broken.\nCheck out the Trolley instead!'
