...
class LeaderboardPage(ShtikerPage):
    ...
    def load(self):
        ...
        self.title = DirectLabel(parent=self, relief=None, text=TTLocalizer.LeaderboardPageTitle, text_scale=0.12, textMayChange=1, pos=(0, 0, 0.6), text_font=ToontownGlobals.getCompetitionFont())
