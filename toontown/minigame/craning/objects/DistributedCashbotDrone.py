...
New structure:
- DistributedCashbotDroneBase - Base class with common functionality
- DistributedCashbotDroneLaser - Laser drone implementation
- DistributedCashbotDroneHeal - Heal drone implementation  
- DistributedCashbotDroneExplodey - Explodey drone implementation
- DistributedCashbotDroneStun - Stun drone implementation

This file now acts as a compatibility layer that routes to the appropriate class.
"""

from toontown.minigame.craning.objects.DistributedCashbotDroneLaser import DistributedCashbotDroneLaser


# For backwards compatibility, map the old class name to Laser drone
# (since Laser was the default/original type)
class DistributedCashbotDrone(DistributedCashbotDroneLaser):
    """
    Backwards compatibility wrapper.
    Defaults to Laser drone behavior.
    """
    
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedCashbotDrone')
