...
from toontown.minigame.craning.objects.DistributedCashbotDroneBase import DistributedCashbotDroneBase
import math


class DistributedCashbotDroneShield(DistributedCashbotDroneBase):
    """
    Shield drone that:
    ...
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedCashbotDroneShield')
    
    def __init__(self, cr):
        DistributedCashbotDroneBase.__init__(self, cr)
    ...
    def activateShield(self, task=None):
        ...
        def pulseTask(task):
            return DistributedCashbotDroneShield._updateShieldPulseStatic(task, owner)
    ...
    def vanishDroneOnly(self, task=None):
        ...
        return DistributedCashbotDroneBase.vanishWithPoof(self, task)
    ...
    def createShieldBubble(self, owner):
        ...
        def rotateRingsTask(task):
            return DistributedCashbotDroneShield._rotateRingsStatic(task, owner)
    ...
    def disable(self):
        ...
        DistributedCashbotDroneBase.disable(self)
