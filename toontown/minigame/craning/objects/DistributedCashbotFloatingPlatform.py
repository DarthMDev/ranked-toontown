...
class DistributedCashbotFloatingPlatform(DistributedObject):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedCashbotFloatingPlatform')
    ...
    def loadModel(self):
        ...
        print('[DistributedCashbotFloatingPlatform] loadModel: doId=%s, index=%s' % (self.doId, self.index))
        ...
        print('[DistributedCashbotFloatingPlatform] Created model node: %s, parent=%s' % (self.model, self.model.getParent()))
        ...
        print('[DistributedCashbotFloatingPlatform] Created parentingNode: %s, parent=%s, getTop()=%s' % (
        ...
        print('[DistributedCashbotFloatingPlatform] After setupCopyModel: parentToken=%s, parentingNode=%s, parentingNode.getTop()=%s' % (
        ...
        print('[DistributedCashbotFloatingPlatform] After reparenting parentingNode to platform: parent=%s, getTop()=%s' % (
        ...
        print('[DistributedCashbotFloatingPlatform] After reparenting platform to model: platform.parent=%s, parentingNode.getTop()=%s' % (
        ...
        print('[DistributedCashbotFloatingPlatform] Re-registered parentToken=%s with parentingNode=%s, getTop()=%s' % (
            self.platform.parentToken, self.platform.parentingNode, self.platform.parentingNode.getTop()))
