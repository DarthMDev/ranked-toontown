...
class DistributedCashbotGoonAI(DistributedGoonAI.DistributedGoonAI, DistributedCashbotObjectAI.DistributedCashbotObjectAI):
    ...
    def doFree(self, task):
        ...
        DistributedCashbotObjectAI.DistributedCashbotObjectAI.doFree(self, task)
    ...
    def hitPlatform(self, platformIndex):
        ...
        if avId == self.avId and self.state in ('Dropped', 'Falling', 'SlidingFloor'):
            ...
            DistributedCashbotObjectAI.DistributedCashbotObjectAI.hitPlatform(self, platformIndex)
