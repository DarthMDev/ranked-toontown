...
from toontown.minigame.craning.objects import DistributedCashbotSafe, DistributedCashbotCrane, \
    DistributedCashbotGoon
...
class DistributedCashbotSideCrane(DistributedCashbotCrane.DistributedCashbotCrane, FSM.FSM):
    ...
    def __init__(self, cr):
        DistributedCashbotCrane.DistributedCashbotCrane.__init__(self, cr)
        FSM.FSM.__init__(self, 'DistributedCashbotSideCrane')

    def getName(self):
        return 'SideCrane-%s' % self.index
        
    def grabObject(self, obj):
        if isinstance(obj, DistributedCashbotSafe.DistributedCashbotSafe):
            return
        else:
