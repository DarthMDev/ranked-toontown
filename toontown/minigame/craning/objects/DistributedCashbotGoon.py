...
from toontown.minigame.craning.objects import DistributedCashbotObject
from direct.showbase import PythonUtil
from toontown.minigame.utils.objects import DistributedGoon


class DistributedCashbotGoon(DistributedGoon.DistributedGoon, DistributedCashbotObject.DistributedCashbotObject):
    
    """ This is a goon that walks around in the Cashbot CFO final
    battle scene, tormenting Toons, and also providing ammo for
    defeating the boss. """
    
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedCashbotGoon')
    ...
    def __init__(self, cr):
        DistributedCashbotObject.DistributedCashbotObject.__init__(self, cr)
    ...
    def generate(self):
        DistributedCashbotObject.DistributedCashbotObject.generate(self)
        DistributedGoon.DistributedGoon.generate(self)

    def announceGenerate(self):
        DistributedCashbotObject.DistributedCashbotObject.announceGenerate(self)
    ...
    def disable(self):
        ...
        DistributedCashbotObject.DistributedCashbotObject.disable(self)

    def delete(self):
        DistributedGoon.DistributedGoon.delete(self)
        DistributedCashbotObject.DistributedCashbotObject.delete(self)
    ...
    def prepareGrab(self):
        DistributedCashbotObject.DistributedCashbotObject.prepareGrab(self)
        if self.isStunned:
    ...
    def prepareRelease(self):
        DistributedCashbotObject.DistributedCashbotObject.prepareRelease(self)
        if self.crane:
    ...
    def setObjectState(self, state, avId, craneId):
        if state == 'W':
            ...
            DistributedCashbotObject.DistributedCashbotObject.setObjectState(self, state, avId, craneId)
    ...
    def enterOff(self):
        ...
        DistributedCashbotObject.DistributedCashbotObject.enterOff(self)

    def exitOff(self):
        DistributedCashbotObject.DistributedCashbotObject.exitOff(self)
