...
class DistributedCashbotDroneGhosty(DistributedCashbotDroneBase):
    """
    Ghosty drone that:
    ...
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedCashbotDroneGhosty')
    ...
    def delete(self):
        ...
        self.removeGhostEffects()
        DistributedCashbotDroneBase.delete(self)
