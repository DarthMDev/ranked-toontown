...
class DistributedCashbotSafe(DistributedCashbotObject.DistributedCashbotObject):
    ...
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedCashbotSafe')
