...
class DistributedCashbotDroneExplodeyAI(DistributedCashbotDroneBaseAI):
    """
    ...
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedCashbotDroneExplodeyAI')
    
    def __init__(self, air, boss, ownerId):
        DistributedCashbotDroneBaseAI.__init__(self, air, boss, ownerId)
        self.hitCFO = False
