...
class DistributedCashbotTreasureAI(DistributedSZTreasureAI.DistributedSZTreasureAI):
    ...
    def __init__(self, air, boss, goon, style, fx, fy, fz):
        ...
        air.memoryDebugger.track_weak(self, "CraneGameTreasure")
        ...
        if avId in self.air.doId2do:
            ...
            if av.hp > 0 and av.hp < av.maxHp:
                ...
                if boss.ruleset.TREASURE_POINT_PENALTY:
                    ...
                    boss.addScore(avId, -amount, reason=CraneGameGlobals.ScoreReason.TOOK_TREASURE)
