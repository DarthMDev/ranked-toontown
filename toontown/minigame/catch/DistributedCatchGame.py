...
from otp.otpbase.PythonUtil import Functor, bound, lineupPos, lerp
...
from toontown.minigame.catch.DropPlacer import *
from toontown.minigame.catch.DropScheduler import *
