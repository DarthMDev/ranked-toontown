...
class EscapeToonSD(StateData.StateData):
    notify = DirectNotifyGlobal.directNotify.newCategory('EscapeToonSD')
    ...
    def __init__(self, avId, game):
        ...
        self.fsm = ClassicFSM.ClassicFSM('EscapeAnimFSM-%s' % self.avId, [State.State('init', self.enterInit, self.exitInit, ['normal']),
