...
class DistributedEscapeGame(DistributedMinigame):
    ...
    def __init__(self, cr):
        ...
        self.gameFSM = ClassicFSM.ClassicFSM('DistributedEscapeGame', [State.State('off', self.enterOff, self.exitOff, ['play']),
    ...
    def getTitle(self):
        return TTLocalizer.EscapeTitle

    def getInstructions(self):
        return TTLocalizer.EscapeInstructions
    ...
    def load(self):
        ...
        self.toonSDs = {}
        avId = self.localAvId
        toonSD = EscapeToonSD.EscapeToonSD(avId, self)
