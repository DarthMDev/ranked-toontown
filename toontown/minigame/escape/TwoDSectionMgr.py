...
class TwoDSectionMgr(DirectObject):
    ...
    def setupEndSection(self, index):
        ...
        sdText = DirectGui.OnscreenText(text=TTLocalizer.EscapeElevatorExit, font=ToontownGlobals.getSuitFont(), pos=(0, -0.34), scale=0.15, mayChange=False, parent=sdSign)
