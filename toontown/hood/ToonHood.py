...
class ToonHood(Hood.Hood):
    ...
    def enterPurchase(self, pointsAwarded, playerMoney, playerIds, playerStates, remain, instaLeaveFlag=False, skillProfileDeltas=None):
        ...
        self.purchase.setShouldInstantlyLeave(instaLeaveFlag)
        self.purchase.load()
        self.purchase.enter()
